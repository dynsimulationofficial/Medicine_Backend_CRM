...
SystemuserRouter.post(
  "/unblockuser",
  requireAuth,
  systemuserController.unblockUser,
);
SystemuserRouter.get(
  "/listblockuser",
  requireAuth,
  systemuserController.listBlockedUsers,
);
SystemuserRouter.get(
  "/assigned-lead-notifications",
  requireAuth,
  leadController.getAssignedLeadNotifications,
);

/* -------------------- User Activity -------------------- */
SystemuserRouter.post(
  "/user-activity/log",
  userActivityController.logUserActivity,
);
SystemuserRouter.get(
  "/user-activity",
  userActivityController.getAllUserActivities,
);
SystemuserRouter.post(
  "/user-activity/filter",
  userActivityController.filterUserActivities,
);
SystemuserRouter.get("/users", userActivityController.getAllUserNamesAndUUIDs);
SystemuserRouter.get(
  "/users/deleted",
  userActivityController.getAllDeletedUsers,
);
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      if (!fcmtoken) {
        return res
          .status(400)
          .json({ success: false, msg: "FCM token required" });
      }
      ...
      return res
        .status(500)
        .json({ success: false, msg: "Failed to register FCM token" });
    }
  },
);
...
SystemuserRouter.get(
  "/leads/assigned",
  requireAuth,
  leadController.getAssignedLeads,
);
SystemuserRouter.post(
  "/leads/assigned/bulk",
  requireAuth,
...
SystemuserRouter.post(
  "/assignlead",
  requireAuth,
  leadController.assignLeadToAgent,
);
SystemuserRouter.post("/leads/filter", requireAuth, leadController.searchLeads);
SystemuserRouter.post(
  "/unassignedleads/filter",
  requireAuth,
  leadController.filterUnassignedLeads,
);
SystemuserRouter.post(
  "/leads/unassigned/filter",
  requireAuth,
  leadController.filterUnassignedLeads,
);
SystemuserRouter.post(
  "/notassignedleads/filter",
  requireAuth,
  leadController.filterUnassignedLeads,
);
SystemuserRouter.post(
  "/lead/activity/filter",
  leadActivityHistoryController.filterlistActivities,
);
...
SystemuserRouter.post(
  ...
  requireAuth,
  leadActivityHistoryController.addActivity,
);
SystemuserRouter.post(
  "/leads/activities/list",
  leadActivityHistoryController.listActivities,
);
SystemuserRouter.post(
  "/leads/getactivity",
  leadActivityHistoryController.getActivityById,
);
SystemuserRouter.post(
  "/leads/update/activity",
  requireAuth,
  leadActivityHistoryController.updateActivity,
);
SystemuserRouter.get(
  "/leads/dispositions/all",
  leadActivityHistoryController.getAllDispositions,
);
SystemuserRouter.get(
  "/leads/dispositions/id",
  leadActivityHistoryController.getDispositionById,
);
SystemuserRouter.post(
  "/leads/activities/delete",
  requireAuth,
  leadActivityHistoryController.softDeleteActivity,
);
SystemuserRouter.post(
  "/leads/activities/soft-delete",
  requireAuth,
  leadActivityHistoryController.softDeleteActivity,
);
SystemuserRouter.post(
  "/leads/activity/delete",
  requireAuth,
  leadActivityHistoryController.softDeleteActivity,
);
SystemuserRouter.post(
  "/leads/activity/soft-delete",
  requireAuth,
  leadActivityHistoryController.softDeleteActivity,
);
SystemuserRouter.post(
  "/leads/soft-delete",
  requireAuth,
  leadController.softDeleteLeads,
);
...
SystemuserRouter.post(
  "/leads/tasks/delete",
  requireAuth,
  leadTaskController.softDeleteTask,
);
SystemuserRouter.post(
  "/leads/tasks/soft-delete",
  requireAuth,
  leadTaskController.softDeleteTask,
);
SystemuserRouter.post(
...
/* -------------------- Lead Documents -------------------- */
SystemuserRouter.post(
  "/leads/documents/list",
  leadDocumentController.listDocuments,
);
SystemuserRouter.post(
  "/leads/documents/upload",
...
SystemuserRouter.post(
  "/leads/documents/download",
  leadDocumentController.getDocumentUrl,
);
SystemuserRouter.post(
  "/leads/documents/delete",
  requireAuth,
  leadDocumentController.softDeleteDocument,
);
SystemuserRouter.post(
  "/leads/documents/soft-delete",
  requireAuth,
  leadDocumentController.softDeleteDocument,
);
SystemuserRouter.post(
...
SystemuserRouter.post(
  "/leads/document/soft-delete",
  requireAuth,
  leadDocumentController.softDeleteDocument,
);
SystemuserRouter.post(
  "/leads/document/notes",
  requireAuth,
  leadDocumentController.updateDocumentNotes,
);
SystemuserRouter.post(
  "/leads/documents/notes",
  requireAuth,
  leadDocumentController.updateDocumentNotes,
);
SystemuserRouter.post(
  "/leads/documents/update/notes",
  requireAuth,
  leadDocumentController.updateDocumentNotes,
);
SystemuserRouter.post(
  "/leads/documents/edit",
  requireAuth,
  leadDocumentController.updateDocumentNotes,
);
SystemuserRouter.post(
  "/leads/documents/get",
  leadDocumentController.getDocument,
);
SystemuserRouter.post(
  "/leads/documents/filter",
  leadDocumentController.filterDocuments,
);
SystemuserRouter.post(
  "/leads/documents/geturl",
  leadDocumentController.getDocumentUrl,
);

/* -------------------- Lead Medicines / Order Items -------------------- */
SystemuserRouter.post(
  "/leads/medicines/save",
  requireAuth,
  leadOrderController.saveLeadMedicines,
);
SystemuserRouter.post(
  "/leads/medicines/list",
  requireAuth,
  leadOrderController.listLeadMedicines,
);
SystemuserRouter.post(
  "/leads/medicines/delete",
  requireAuth,
  leadOrderController.deleteLeadMedicine,
);
SystemuserRouter.get(
  "/leads/medicines/suggestions",
  requireAuth,
  leadOrderController.getMedicineSuggestions,
);
...
SystemuserRouter.post(
  "/leads/orders/save",
  requireAuth,
  leadOrderController.saveLeadOrder,
);
SystemuserRouter.post(
  "/leads/orders/list",
  requireAuth,
  leadOrderController.listLeadOrders,
);
SystemuserRouter.post(
  "/leads/orders/delete",
  requireAuth,
  leadOrderController.deleteLeadOrder,
);
SystemuserRouter.post(
  "/leads/orders/update-status",
  requireAuth,
  leadOrderController.updateLeadOrderStatus,
);
...
SystemuserRouter.post(
  ...
  requireAuth,
  agentDashboardController.getAgentTasksDashboard,
);
SystemuserRouter.post(
...
SystemuserRouter.get(
  "/leads/search/dashboard",
  requireAuth,
  agentDashboardController.searchLeadsForDashboard,
);
...
SystemuserRouter.get(
  "/medicines",
  requireAuth,
  masterMedicineController.getAllMedicines,
);
SystemuserRouter.get(
  "/medicines/:id",
  requireAuth,
  masterMedicineController.getMedicineById,
);
...
SystemuserRouter.delete(
  "/medicines/:id",
  requireAuth,
  masterMedicineController.deleteMedicine,
);
...
SystemuserRouter.get(
  "/lead-sources",
  requireAuth,
  leadSourceController.getAllLeadSources,
);
SystemuserRouter.get(
  "/lead-sources/search",
  requireAuth,
  leadSourceController.searchLeadSources,
);
SystemuserRouter.get(
  "/lead-sources/:id",
  requireAuth,
  leadSourceController.getLeadSourceById,
);
SystemuserRouter.put(
  "/lead-sources/:id",
  requireAuth,
...
SystemuserRouter.get(
  "/campaigns/by-source",
  requireAuth,
  campaignController.getCampaignsBySource,
);
SystemuserRouter.get(
  "/campaigns/:id",
  requireAuth,
...
SystemuserRouter.post(
  "/tracking/sync",
  requireAuth,
  trackingController.syncTracking,
);
SystemuserRouter.post(
  "/tracking/history",
  requireAuth,
